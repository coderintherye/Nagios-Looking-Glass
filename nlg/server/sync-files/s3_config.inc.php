...
// *** CLIENT-SIDE CONFIGURATION *** //
  ...
  $ClientSiteName = "San Francisco State University, Division of Information Technology";

  // Company name
  $ClientCompanyName = "San Francisco State University, Division of Information Technology";

  // Admin e-mail address
  $ClientAdminEmailAddress = "systems@sfsu.edu";

  // HTTP path to the logo - can be absolute or relative to index.php
  $ClientCompanyLogo = "templates/default/images/logo.gif";
...
//  $ClientACL_AllowList = Array('127.0.0.1'); //
  $ClientACL_AllowList = Array('10.10.10.205,130.212.9.151,127.0.0.1');
  $ClientACL_BlockList = Array();

// *** SERVER-SIDE CONFIGURATION *** //

  // The URL to download the server feed from (client-side)
//  $ServerFeed_URL = "https://aldebaran.sfsu.edu/server/s3_poller.php";
  $ServerFeed_URL = "https://10.10.10.159/server/s3_poller.php";
  ...
  $ServerNagiosFeed = "/usr/local/nagios/var/";
  ...
  //    AD = allow first, then deny
  //    DA = deny first, then allow
  $ServerACL_ApplyOrder = "AD";

  // IP Access Control Lists
  $ServerACL_AllowList = Array('10.10.10.205,127.0.0.1');
...
// *** MISC CONFIGURATION *** //
  ...
  $Update_DownloadLink = "http://www.nagioslookingglass.co.uk/download";

  // The DNS record to query for the current version
  // Ordinarily you won't need to change this
  $Update_DNSRecordToCheck = "version-beta.nagioslookingglass.co.uk";
